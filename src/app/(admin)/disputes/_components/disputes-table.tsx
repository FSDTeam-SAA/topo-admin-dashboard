      ...
      <Table>
        <TableHeader>
          <TableRow className="border-none">
            <TableHead className="w-[100px] text-center">Dispute ID</TableHead>
            <TableHead className="w-[100px] text-center">Customer ID</TableHead>
            <TableHead className="w-[100px] text-center">Lender ID</TableHead>
            <TableHead className="w-[100px] text-center">Insurance</TableHead>
            <TableHead className="w-[100px] text-center">Issue</TableHead>
            <TableHead className="w-[100px] text-center">Status</TableHead>
            <TableHead className="w-[100px] text-center">
              Dispute Date
            </TableHead>
            <TableHead className="w-[100px] text-center">AI Draft</TableHead>
            <TableHead className="w-[100px] text-center">
              Suggested Action
            </TableHead>
